...
//	public static WebEventListener eventListener;
	...
	public TestBase(){
		try {
			prop = new Properties();
			FileInputStream ip = new FileInputStream(("C:\\Users\\uttam\\eclipse-workspace\\FreeCRMTest\\src\\main\\java\\com\\crm\\qa\\config\\config.properties"));
			prop.load(ip);
	...
	public static void initialization(){
		...
		if(browserName.equals("chrome")){
			 System.setProperty("webdriver.chrome.driver", "C:\\Users\\uttam\\Downloads\\chromedriver\\chromedriver.exe"); 
			  WebDriver driver = new ChromeDriver(); 
		}
		else if(browserName.equals("FF")){
			System.setProperty("webdriver.gecko.driver", "C:\\Users\\uttam\\Downloads\\chromedriver\\geckodriver.exe"); 
